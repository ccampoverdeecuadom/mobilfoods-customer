...
class S {
  ...
  String get buy_your_products_here {
    return Intl.message(
      'Buy your products here',
      name: 'buy_your_products_here',
      desc: '',
      args: [],
    );
  }

  /// `Your order will be delivered the next business day`
  String get your_order_will_be_delivered_the_next_business_day {
    return Intl.message(
      'Your order will be delivered the next business day',
      name: 'your_order_will_be_delivered_the_next_business_day',
      desc: '',
      args: [],
    );
  }
  ...
  /// `Not a valid Ci or RUC`
  String get not_a_valid_ci_ruc {
    return Intl.message(
      'Not a valid Ci or RUC',
      name: 'not_a_valid_ci_ruc',
      desc: '',
      args: [],
    );
  }
