                    ...
                    child: Column(
                      children: <Widget>[
                        ...
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                          keyboardType: TextInputType.text,
                          decoration: getInputDecoration(hintText: '9999999999', labelText: S.of(context).identification),
                          initialValue: widget.user.ci,
                          validator: (input) => input.trim().length < 10 ? S.of(context).not_a_valid_full_name : null,
                          onSaved: (input) => widget.user.ci = input,
                        ),
                        new TextFormField(
                          style: TextStyle(color: Theme.of(context).hintColor),
                        ...
                        new TextFormField(
                          ...
                          decoration: getInputDecoration(hintText: '0987654321', labelText: S.of(context).phone),
