...
class NotificationPlugin {
  ...
  Future<void> showNotificationVoid() async {
    var androidChannelSpecifics = AndroidNotificationDetails(
      'y',
      'yn',
      "channelDescription",
  ...
  Future<void> showNotificationWithAttachment(Order order) async {
    var attachmentPicturePath = await _downloadAndSaveFile(
        'http://50.19.48.21/storage/app/public/1/Winden.jpeg', 'attachment_img.jpg');
    ...
    var bigPictureStyleInformation =  BigPictureStyleInformation(
      ...
      contentTitle: '<h1>mobilfoods</h1> <b>Actualización de tu pedido</b>',
