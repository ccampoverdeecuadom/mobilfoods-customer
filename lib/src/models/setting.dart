...
class Setting {
  ...
  bool enableSaleFunctions;
  DateTime preLaunchDate;
  ...
  Setting.fromJSON(Map<String, dynamic> jsonMap) {
    try {
      ...
      enableSaleFunctions = jsonMap['enable_sale_functions'] == 0 ? false : true;
      preLaunchDate = jsonMap
      ['pre_launch_date'] != null ? DateTime.parse(jsonMap['pre_launch_date']) : new DateTime(2021, 4, 2, 14, 0, 0);
