...
class _CartWidgetState extends StateMVC<CartWidget> {
  ...
  _CartWidgetState() : super(CartController(false)) {
    _con = controller;
  }
  ...
  void initState() {
    _con.listenForCarts();
    super.initState();
    myController = TextEditingController()..text = coupon?.code ?? '';
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Scaffold(
        ...
        bottomNavigationBar: CartBottomDetailsWidget(con: _con, isChecked: true,),
        appBar: AppBar(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      Expanded(child:
                        ...
                        IconButton(icon: Icon(Icons.check), color: Colors.green, onPressed: () => _con.doApplyCoupon(myController.value.text))
                      ],)
