...
class _OrderSuccessWidgetState extends StateMVC<OrderSuccessWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    child:Scaffold(
        ...
        body:  _con.orderAdded == null
            ? CircularLoadingWidget(
          height: 500,
        )
            : !dataInvoiceCheck
            ? InvoiceDataWidget(
            order: _con.orderAdded, onChanged: _dataInvoiceComplete)
            : _con.carts.isEmpty
  ...
  _dataInvoiceComplete() {
    setState(() {
      dataInvoiceCheck = true;
    });
  }
}
