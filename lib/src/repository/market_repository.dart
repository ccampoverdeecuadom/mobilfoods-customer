...
setCurrentMarketId(marketId) async {
  currentMarketId = marketId;
  SharedPreferences prefs = await SharedPreferences.getInstance();
  await prefs.setString('current_market_id', marketId);
}
...
Future<Stream<Market>> getNearMarkets(
  ...
  if (!myLocation.isLatLnUnknown() && !areaLocation.isLatLnUnknown()) {
