  ...
  try {
    ...
    if (response.statusCode == 200 &&
      ...
      if (json.decode(response.body)['data'] != null) {
        ...
        if (prefs.containsKey('current_market_id')) {
          setCurrentMarketId(prefs.get('current_market_id'));
        }
...
Future<Address> getCurrentLocation() async {
  ...
  if (prefs.containsKey('delivery_address')) {
    ...
    setCurrentLocation().then((value) => {
      changeCurrentLocation(Address.fromJSON(value)),
      deliveryAddress.value = Address.fromJSON(value)
    });
